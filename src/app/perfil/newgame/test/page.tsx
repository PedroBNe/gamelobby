    ...
    return(
        <div className="w-full h-full flex flex-col justify-between items-center">
            ...
            <div className="w-full p-10 flex gap-10">
                ...
                <div className="flex flex-col gap-10">
                    ...
                    <div className="w-full flex flex-col gap-5 text-start">
                        ...
                        <Button variant={'verde'} className="w-[10vw] h-[5vh]" onClick={() => Alert('Jogo publicado com sucesso!')}>PUBLICAR!</Button>
                    </div>
                </div>
            </div>
            <div className="w-full p-16 flex justify-between">
                ...
                <Link href="/perfil">
                    <Button variant={'verde'} className="rounded-full" size={"lg"} onClick={() => Alert('Jogo criado com sucesso!')}>SALVAR</Button>
                </Link>
            </div>
        </div>
    )
